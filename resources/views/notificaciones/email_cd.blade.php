...
<table align="center" cellpadding="0" cellspacing="0" width="100%" height="100%" >
  <tr>
    ...
    <table cellspacing="0" cellpadding="0" width="100%">
            ...
            <table cellspacing="0" cellpadding="0" width="500" class="w320">
              <tr>
                <td valign="top" style="padding:10px 0; text-align:center;" class="mobile-center">
                  <img src="https://i.ibb.co/HprPcB7/sime-logo2.png" alt="logo-SIME" border="0" width="75%" height="75%">
                </td>
              </tr>
            </table>
          </center>
      ...
      <tr>
        <td valign="top" style="background-color:#E8E9E8 !important;">
                  ...
                  <table cellspacing="0" cellpadding="0" width="100%">
                    <tr>
                      <td style="text-align: center;">
                        <h1 style="color:black !important;">Aviso importante!</h1>
                        <br>
                      </td>
                    </tr>
                  </table>
                  ...
                  <table style="margin: 0 auto;" cellspacing="0" cellpadding="8" width="100%">
                    <tr>
                      <td style="border: 1px solid #a1a1a1; text-align:justify;">
                        <p>Primeramente muy buenos días, tardes o noches, esperando que se encuentre en excelentes condiciones. Es la tercera oportunidad en la que le enviamos la presente notificación. <br>
