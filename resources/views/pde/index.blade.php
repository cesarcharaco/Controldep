@extends('layouts.app')
@section('title') Asignaciones @endsection
@section('content')
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark"><!-- <i class="nav-icon fa fa-shopping-basket"></i> --> Asignaciones</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
      ...
      <div class="col-12">
        <div class="card card-primary card-outline card-tabs">
          ...
          <div class="card-header">
            <h3 class="card-title"><!-- <i class="nav-icon fa fa-shopping-basket"></i> --> Asignaciones registradas</h3>
